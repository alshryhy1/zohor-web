  ...
  return (
    <LegalPage title="معايير المجتمع" titleEn="Community Standards">
      ...
      <LegalSection title="الإبلاغ">
        <p>
          أبلغ عن محتوى أو حساب مخالف عبر الدعم: {LEGAL_CONTACT} مع رابط أو اسم المستخدم ووصف مختصر. نراجع البلاغات
          الجادّة في أقرب وقت ممكن، وعلى الأرجح خلال 24 ساعة للمحتوى الخطير.
        </p>
      </LegalSection>
      ...
      <LegalSection title="الحظر والكتم والطرد">
        <p>
          ...
          يمكنك حظر من يسيء إليك عبر الدعم إلى أن تتوفر أداة الحظر داخل كل شاشة. الحسابات المخالفة قد تُعلَّق منّا.
        </p>
      </LegalSection>
