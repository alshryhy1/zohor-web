    ...
    <LegalPage title="شروط الاستخدام" titleEn="Terms of Use">
      ...
      <LegalSection title="اللمعات والمشتريات">
        <p>
          ...
          غير المسلّمة وفق آلية التحقق لدينا، لا على وحدات أُنفقت كهدايا. لا توجد اشتراكات متجددة تلقائيًا في الحزم
          الحالية — الشراء لمرة واحدة لكل حزمة استهلاكية.
        </p>
        <p>
          لاستخدام التطبيق على iOS تنطبق أيضًا شروط التطبيق المرخّص القياسية من أبل (Apple Licensed Application End
          User License Agreement) بالإضافة إلى هذه الشروط.
        </p>
      </LegalSection>
